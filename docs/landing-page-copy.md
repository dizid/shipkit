...
**Intro line:**
You can ship code in your sleep. But launching? That's a different problem.

**Pain point 1 — Title:** You built it. Now what?
You've been heads-down for months. The app works. But you have zero users, zero revenue, and a nagging feeling that "just posting on Twitter" isn't a strategy.

**Pain point 2 — Title:** Too much noise, no signal.
You Googled "how to launch a SaaS" and found 47 conflicting guides, 12 YouTube tutorials, and a $500 course that promises to make you rich. None of them tell you what to actually do Monday morning.

**Pain point 3 — Title:** You're a developer, not a marketer.
Marketing feels like a foreign language. You know your product is good — but writing copy, finding the right tools, and figuring out what order to do things? That's not in the curriculum.

---

## 4. Solution / How It Works Section
...
- Set up your landing page and capture emails before you ship
- Define your positioning so your copy actually converts
- Configure analytics so you know where users come from
...
**Phase 2 — Launch Week**
Tasks 6–12 | Launcher tier

- Post your launch to the right places in the right order
- Generate AI-personalized copy for Product Hunt, Indie Hackers, and Hacker News
- Handle your first user conversations without fumbling

Tier badge: Launcher — $29

---

**Phase 3 — First 30 Days**
Tasks 13–22 | Launcher tier

- Build your feedback loop and turn users into case studies
- Set up email sequences that convert trial users to paid
- Find your first distribution channel that isn't "hope"
...
**Phase 4 — Scaling**
Tasks 23–32 | Pro tier

- Double down on what's working and kill what isn't
- Automate acquisition channels so growth runs without you
- Prepare for press, affiliate programs, and paid distribution
...
**Section heading:** Built for how developers actually work

---

**Feature 1 — AI-Personalized Copy**
...
**Feature 2 — Opinionated Tool Picks**

Title: One tool recommendation. Not twenty.

Description: Every task that requires a tool includes a single, specific recommendation — the one that works for solo founders at your stage. No comparison matrices, no affiliate rabbit holes, no decision fatigue.

Example: For email capture, we don't list 15 options. We say "use Loops" and tell you exactly how to set it up. You move on. That's it.

---

**Feature 3 — Step-by-Step Checklist**
...
**Section heading:** One price. No games.

**Subheading:** Most indie devs need Launcher. Grab it once, use it forever.
...
What's included:
- Phase 1: 5 foundation tasks
- Landing page setup task
- Email capture setup task
...
**Launcher — $29 one-time** [MOST POPULAR badge]

What's included:
- Everything in Free
- All 32 tasks across all 4 phases
- Unlimited AI copy generations
- Templates for every launch channel (PH, IH, HN, Twitter, email)
- Opinionated tool picks with setup guides
- Phase-by-phase unlock so you don't get overwhelmed
...
What's additional on top of Launcher:
- New launch strategies added monthly
- Priority support (responses within 24 hours)
- Private community access (async, low-noise)
- Early access to new features and tasks

Button: Get Pro

Micro-copy: Cancel anytime. No lock-in.
...
**Headline:**
You built the hard part. Now ship it.

**Subtext:**
The checklist is ready. The AI is standing by. Your next step is one click.

**CTA button:** Start Free — No Credit Card

**Micro-copy below button:**
Launcher is $29 one-time. Pro is $9/month. Free is free.
